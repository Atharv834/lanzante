export const projectsData = [
    {
        ...
        specs: [
            ...
            { label: 'Power', value: '986 bhp' },
            { label: 'Weight', value: '< 1440 kg' },
            { label: 'Production', value: '6 Units' }
        ]
    },
    {
        id: 'tag-turbo',
        ...
        specs: [
            ...
            { label: 'Power', value: '503 bhp (Road Tuned)' },
            { label: 'Production', value: '11 Units' }
        ]
    },
    {
        id: '935',
        ...
        specs: [
            ...
            { label: 'Power', value: '700 bhp' },
            { label: '0-60 mph', value: '2.5 sec' },
            { label: 'Conversion', value: 'Road Legal Spec' }
        ]
    }
];
